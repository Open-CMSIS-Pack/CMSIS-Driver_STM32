...
__Conceptual__ deviations:
  - the STM32CubeMX generated initialization code (function MX_I2Cn_Init) will already
...
This is example of configuring **I2C1** on the **STM32H735IGK3** device with the **STM32CubeMX** tool.

...
This driver supports USB **High** and **Full** speeds.
...
__Conceptual__ deviations:
  - the STM32CubeMX generated initialization code (function MX_USB_...PCD_Init) will already
...
This is example of configuring **USB_OTG_FS** and **USB_OTG_HS** on the **STM32H743XIH6** device with the **STM32CubeMX** tool.

...
- Version 3.5
  - Added support for Gigabit Ethernet
- Version 3.4
...
__Functional__ deviations:
  ...
  - Control:
    ...
    - for control code `ARM_ETH_MAC_VLAN_FILTER` the VLAN filter control is supported on newer STM32H and STM32N devices.
  - ControlTimer:
    - not supported by HAL.
...
Add **RxDescripSection**, **TxDescripSection**, **driver.eth_mac0_rx_buf** and **driver.eth_mac0_tx_buf**
